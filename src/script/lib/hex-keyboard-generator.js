/*
 * Hex keyboard generator 0.0.0
 * Based on Qwerty Hancock keyboard library v0.4.3
 * https://github.com/stuartmemo/qwerty-hancock/blob/920e502/dist/qwerty-hancock.js
 */
    ...
    */
    var styleKeyboard = function (keyboard) {
        var styleElement = function (el) {
            ...
            el.style.fontSize = '0.25em'; //(settings.width / 100) + 'em';
        };
    ...
    var createKeys = function () {
        ...
        for (i = 0; i < total_white_keys; i++) {
            ...
            key = createKey({
                ...
                height: getWhiteKeyWidth(total_white_keys) * Math.sqrt(3) / 2,
